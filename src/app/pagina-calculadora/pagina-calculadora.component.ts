...
@Component({
  selector: 'app-pagina-calculadora',
  templateUrl: './pagina-calculadora.component.html',
  styleUrls: ['./pagina-calculadora.component.less']
})
export class PaginaCalculadoraComponent implements OnInit{
  ...
  flagdivisaoPorZero: boolean = false;
